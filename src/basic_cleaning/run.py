...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "Entering the initial artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "Artifact output at end of cleaning",
        required = True
    )
...
>>>>>>> 94b1a4bf4de38bf9cdf1fd87696fe5cdd11a18c4
    go(args)